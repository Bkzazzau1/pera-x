...
<div
	class="glass glow-hover group relative h-28 w-full overflow-hidden rounded-[2.5rem] border-white/5 transition-all duration-700"
>
	<svg
	...
	<div class="relative z-10 flex h-full items-center justify-between px-10">
		<div class="flex flex-col">
			<div class="mb-1 flex items-center gap-2">
				...
				<span class="text-[10px] font-black tracking-[0.4em] text-blue-400/60 uppercase"
					>Monetary Contraction Engine</span
				>
			</div>
		...
		<div class="flex flex-col items-end gap-2">
			...
			<span class="text-[8px] font-bold tracking-[0.3em] text-white/20 uppercase"
				>Network Velocity: Optimized</span
			>
		</div>
	</div>

	<div
		class="absolute inset-0 top-0 h-[1.5px] w-full animate-[scan_5s_linear_infinite] bg-linear-to-b from-transparent via-white/[0.03] to-transparent"
	></div>
</div>
